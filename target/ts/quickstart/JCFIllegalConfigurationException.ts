...
namespace quickstart {
    export class JCFIllegalConfigurationException extends quickstart.JCFException {
        ...
        static __quickstart_JCFIllegalConfigurationException_CLASS_NAME: string = "JCFIllegalConfigurationException";
    }
