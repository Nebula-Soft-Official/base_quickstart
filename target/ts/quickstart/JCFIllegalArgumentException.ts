...
namespace quickstart {
    export class JCFIllegalArgumentException extends quickstart.JCFException {
        ...
        static __quickstart_JCFIllegalArgumentException_CLASS_NAME: string = "JCFIllegalArgumentException";
    }
